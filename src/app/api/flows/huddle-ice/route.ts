...
export const GET = withAuthenticatedApi(async (_request, auth) => {
  ...
  // provider names the tier, never the credentials. relayAvailable is what the
  // huddle UI keys its "your network may need a relay" guidance on.
  return { success: true, iceServers, provider, relayAvailable: provider !== 'stun-only' }
